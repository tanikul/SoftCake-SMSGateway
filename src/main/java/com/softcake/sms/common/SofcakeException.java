...
public class SofcakeException extends Exception {
	...
	public SofcakeException(){
		super();
	}
	
	public SofcakeException(Exception ex){
		super(ex);
	}
	
	public SofcakeException(SofcakeException obj){
	...
	public SofcakeException(Exception ex, HttpServletResponse response){
