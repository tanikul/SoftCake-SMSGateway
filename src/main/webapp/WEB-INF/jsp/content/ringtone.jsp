		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel tile overflow_hidden">
                <div class="x_title">
                  <h2><i class="fa fa-laptop"></i> Upload Video Clip</h2>
						...
						<div class="col-md-12">
							<form class="form-horizontal">
								<div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">ชื่อคอนเทนต์	</label>
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="inputEmail3">
								    </div>
								</div>
								<div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">คำบรรยายคอนเทนต์ <br/>(รายละเอียดที่แสดงในหน้าดาวน์โหลด)</label>
								    <div class="col-sm-10">
								      <textarea style="height:150px;width:500px;"></textarea>
								    </div>
								</div>
								<div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">ภาพ Preview</label>
								    <div class="col-sm-4">
								      <input type="file" class="form-control" id="inputEmail3">
								    </div>
								    <div class="col-sm-6">(.gif หรือ .jpg ขนาด 320x240)</div>
								</div>
								<div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">Content File</label>
								    <div class="col-sm-4">
								      <input type="file" class="form-control" id="inputEmail3">
								    </div>
								    <div class="col-sm-6">(.3gp หรือ .mp4 ขนาดไม่เกิน 5MB)</div>
								</div>
								<div class="form-group">
